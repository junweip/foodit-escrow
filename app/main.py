...
class CreateEscrowRequest(BaseModel):
    customer_id: str  # Stripe Customer ID (from /buyers/onboard)
...
# ---------------------------------------------------------------------------
# 2. Onboard a buyer (create Stripe Customer)
# ---------------------------------------------------------------------------
@app.post("/buyers/onboard", response_model=OnboardBuyerResponse)
def onboard_buyer(req: OnboardBuyerRequest):
    """Create a Stripe Customer for a buyer so they can make payments."""
    try:
...
# ---------------------------------------------------------------------------
# 3. Create an escrow payment (charge the buyer, platform holds funds)
# ---------------------------------------------------------------------------
